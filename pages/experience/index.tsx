                ...
                <div className="flex py-[20px] items-stretch flex-col md:flex-row justify-around">
                    <div className="w-11/12 mx-auto md:w-1/3">
                        ...
                        <p className="mt-4 text-sm leading-[30px]">
                            ...
                            and I have worked with more than 4 companies till
                            date, all while being in college. I learned a lot,
                            did work trips (they have a special place in my
                            heart.)
                            <br />
                            ...
                            <br />
                            <br />
                            Want to hire me as employee/freelancer? drop me a
                            mail at{' '}
                            <span className="font-semibold text-violet-700">
                                rgoel766@gmail.com
                            </span>
