...
const PRICING_PLANS = [
    {
        ...
        price: '$2000 / $1500',
        subtext:
            "I'll build a fully functional MVP in 3 weeks. ($1500 & 2 weeks if designs are provided)",
    },
    {
        name: 'Custom Pricing',
        price: '$1000 onwards',
        subtext:
            'Not clear with your idea? Book a call with me and we can discuss your project in detail',
    },
]
            ...
            <div className="flex flex-row mt-10 gap-10">
                {PRICING_PLANS.map((plan) => (
                    ...
                    >
                        ...
                        <p className="opacity-60 w-full mt-2">{plan.subtext}</p>
