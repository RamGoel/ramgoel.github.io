...
export const projects: Array<ProjectProps> = [
  {
    ...
    description:
      "Dumbel is like Bumble but for developers, just signin with Github and explore profiles of developers from all over the world! It has 35+ users at present.",
    preview: require("@/public/projects/dumbel.png"),
    skills: ["nextjs", "nestjs", "mongodb", "tailwind"],
    extras: "",
    type: "tech",
    madeat: "Side Project",
    year: 2023,
