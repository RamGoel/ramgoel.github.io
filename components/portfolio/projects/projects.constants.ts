...
export const projects: Array<ProjectProps> = [
  {
    ...
    description:
      "Dumbel is like Bumble but for developers, just signin with Github and explore profiles of developers from all over the world! It has 45+ users at present.",
    preview: require("@/public/projects/dumbel.png"),
    skills: ["nextjs", "expressjs", "mongodb", "tailwind"],
    extras: "",
    type: "tech",
    madeat: "Side Project",
    year: 2023,
  ...
  {
    key: 37,
    name: "EcoEcho - Sustainable Life",
    isGrid: true,
    url: "https://sustain-globe.netlify.app/",
    description:
      "EcoEcho is a gamification based application which assigns nature friendly tasks to users which help them reduce their carbon footprint.",
    preview: "https://i.ibb.co/hcxtbL3/image.png",
    skills: ["reactjs", "firebase", "tailwind"],
    extras: "",
    type: "tech",
    madeat: "Solution Challenge 2024",
    year: 2024,
    filter: "full-stack",
  },
  {
    ...
    skills: ["nextjs", "expressjs", "socketio", "next-auth"],
    extras: "",
    type: "tech",
    madeat: "Side Project",
    year: 2023,
  ...
  {
    key: 2,
    name: "Ticketoo - Resell Tickets Easily",
  ...
  {
    key: 8,
    name: "Portify - Make your website",
  ...
  {
    key: 27,
    name: "FeedWell - Eradicate Malnutrition",
  ...
  },
  {
    ...
    skills: ["nextjs", "redux", "typescript"],
    extras: "",
    type: "tech",
    madeat: "Groww",
    year: 2023,
  ...
  {
    key: 32,
    name: "Orgarch - Virtual Conferences",
