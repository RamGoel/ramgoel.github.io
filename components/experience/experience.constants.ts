...
export const experiences:Array<ExperienceProps> = [
    ...
    },
    {
        ...
        description: "Led team of 3 for building website of flagship hackathon event organized by the club, mentored students about google products, and took some tech workshops.",
        role: "Technical Lead",
        type:"position"
    },
    {
        ...
        url: 'https://neyx.in/',
        description: "Built a automated mail system and event website for seamless registration process for the event, got praised by the college management for the website.",
        role: "Manager (Tech)",
        type:"position"
    },
    {
        ...
        skills: ['Google Cloud'],
        url: 'https://neyx.in/',
        description: "Starting with 70+ students, successfully managed to achieve tier3 by helping 40+ student completing the whole program, took some sessions & practical labs. ",
